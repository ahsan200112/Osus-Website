    ...
    <section className="feature-section-2 py-5 text-center">
      <div className="container" style={{marginBottom:"70px"}}>
        ...
        <h2 className="text-dark fw-bold" style={{ fontSize: "40px", fontWeight: "700" }}>
          {t('How Does Our POS System Works?')}
        </h2>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="feature-box p-4 d-flex flex-column justify-content-between">
              ...
              <h5 className="fw-bold">{t('Real-Time Syncing')}</h5>
              <p className="text-muted">{t('All data syncs instantly across devices, whether its a tablet, smartphone, or desktop.')}</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="feature-box p-4 d-flex flex-column justify-content-between">
              ...
              <h5 className="fw-bold">{t('Setup and Configuration')}</h5>
              <p className="text-muted">{t('Customize the system and Import your inventory and set up payment methods.')}</p>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="feature-box p-4 d-flex flex-column justify-content-between">
              ...
              <h5 className="fw-bold">{t('Secure Transactions')}</h5>
              <p className="text-muted">{t('Process payments securely with encryption and compliance with industry standards.')}</p>
            </div>
          </div>
        </div>
      </div>
