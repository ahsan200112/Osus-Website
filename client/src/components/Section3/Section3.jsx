        ...
        <div className="row">
          ...
          <div className="col-lg-7 col-md-7 col-sm-12 text-container">
            <h2 className="fw-bold" style={{ fontSize: "30px", color: "white" }}>
             {t('Streamline Your Business with Our POS System')}
            </h2>
            <p className="fw-bold" style={{ fontSize: "18px", color: "rgba(209, 209, 209, 1)" }}>
            {t('Simplify sales, track inventory, and manage operations effortlessly. Get started today and experience the power of an all-in-one solution!')}
            </p>
